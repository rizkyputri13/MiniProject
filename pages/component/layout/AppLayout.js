...
const navigation = [
    { name: 'Home', href: '/app', icon: HomeIcon, current: true, roles: ['Administrator', 'Recuirter', 'Sales', 'Instructor'] },
    { name: 'Candidat', href: '/app/candidat', icon: AcademicCapIcon, current: false, roles: ['Administrator', 'Recuirter', 'Instructor'] },
    { name: 'Batch', href: '/app/batch', icon: ViewGridAddIcon, current: false, roles: ['Administrator', 'Recuirter', 'Instructor'] },
    { name: 'Talent', href: '/app/talent', icon: UserGroupIcon, current: false, roles: ['Administrator', 'Recuirter', 'Instructor', 'Sales'] },
    { name: 'Placement', href: '/app/placement', icon: UserGroupIcon, current: false, roles: ['Administrator', 'Recuirter', 'Sales'] },
    { name: 'Curriculum', href: '/app/curriculum', icon: BookOpenIcon, current: false, roles: ['Administrator', 'Instructor'] },
    { name: 'Hiring', href: '/app/hiring', icon: PhoneOutgoingIcon, current: false, roles: ['Administrator', 'Recuirter', 'Sales'] },
    { name: 'Setting', href: '/app/setting', icon: CogIcon, current: false, roles: ['Administrator', 'Recuirter', 'Sales', 'Instructor', 'Candidat', 'Talent', 'Outsource'] },
]
